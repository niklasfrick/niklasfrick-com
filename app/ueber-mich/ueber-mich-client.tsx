            ...
            >
                ...
                <div className="space-y-4">
                    <p className="text-base leading-relaxed text-zinc-600 sm:text-lg md:text-xl dark:text-zinc-400">
                        Als Platform Engineer und Solutions Architect entwickle ich Entwicklerplattformen,
                        die Teams dabei unterstützen, effizienter zu arbeiten und bessere Software zu erstellen.
                        Mit über 7 Jahren Erfahrung in Infrastruktur, DevOps-Tools und Plattform-Engineering
                        helfe ich Teams dabei, komplexe technische Konzepte zu verstehen und in praktische
                        Lösungen umzusetzen.
                    </p>
                    <p className="text-base leading-relaxed text-zinc-600 sm:text-lg md:text-xl dark:text-zinc-400">
                        Durch Artikel, Schulungen und praktische Anleitungen teile ich mein Wissen,
                        um komplexe Infrastruktur-Herausforderungen verständlich zu machen und
                        Entwicklerteams produktiver zu machen.
                    </p>
                </div>
            </motion.section>
            ...
            >
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="rounded-lg bg-zinc-50 p-4 dark:bg-zinc-900/50">
                        ...
                        <p className="text-sm text-zinc-600 dark:text-zinc-400">
                            Internal Developer Platforms, Self-Service Tools, Developer Portals
                        </p>
                    </div>
                </div>
            </motion.section>
