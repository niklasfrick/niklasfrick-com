...
export function MetadataBlogDateDisplay({ date, lastUpdated, className = '' }: MetadataBlogDateDisplayProps) {
    const isUpdated = date !== lastUpdated

    return (
        <div className={`flex items-center space-x-2 text-sm text-zinc-500 dark:text-zinc-400 ${className}`}>
